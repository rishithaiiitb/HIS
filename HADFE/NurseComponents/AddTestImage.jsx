...
import CaptureTestImage from "./clickTestImg";

export default function AddTestImage({ navigation, route }) {
  ...
  const handleCaptureImage = async () => {
    navigation.navigate("CaptureTestImage", { patientId,id });
  };
  ...
  const handleImageUpload = async () => {
    try {
      ...
      const response = await axios.post(
        `${API_BASE_URL}/nurse/addTestImage/${id}`,
        { image },
        {
          headers: {
    ...
    <View style={styles.container}>
      ...
      <ImageBackground source={BG_Tests} style={styles.content}>
        ...
        <ScrollView contentContainerStyle={styles.formContainer}>
          <Text style={styles.headerText}>Upload Test Result Images</Text>
