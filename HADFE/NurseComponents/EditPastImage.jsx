...
export default function EditPastImage({ navigation, route }) {
  const [pastImg, setImageUrl] = useState(null);
  ...
  const fetchOldPastImage = async () => {
    try {
      ...
      const response = await axios.get(
        `${API_BASE_URL}/nurse/viewPastImagesById/${historyId}/${imgId}`,
        {
          headers: {
      ...
      console.log(oldPastimage.pastImg);
      setImageUrl(oldPastimage.pastImg);
    } catch (error) {
  ...
  const handleImageUpload = async () => {
    try {
      ...
      const response = await axios.put(
        `${API_BASE_URL}/nurse/editPastImages/${imgId}`,
        { pastImg },
        {
          headers: {
            Authorization: `Bearer ${token}`,
    ...
    <View style={styles.container}>
      ...
      <ImageBackground source={BG_PastHistory} style={styles.content}>
        ...
        <ScrollView contentContainerStyle={styles.formContainer}>
          <Text style={styles.headerText}>Edit Medical History Images</Text>
          <View style={styles.formContent}>
            ...
            {!previewImage && pastImg && (
              <View style={styles.rightContent}>
                <Image source={{ uri: pastImg }} style={styles.imagePreview} />
              </View>
            )}
          </View>
